...
const HeroSection = ({ onBookNow }: HeroSectionProps) => {
  ...
  return (
    <section className="relative overflow-hidden pt-20 md:pt-16">
      <div className="absolute top-0 md:-top-[10vh] left-0 right-0 h-[65vh] md:h-[90vh] bg-white z-0 pointer-events-none" />
      <video
        ref={videoRef}
        src={evolutionVideo}
        autoPlay
        ...
        x5-playsinline="true"
        className="absolute top-0 md:-top-[10vh] left-1/2 -translate-x-1/2 w-[85%] md:w-[60%] h-[65vh] md:h-[90vh] object-contain object-center z-0 pointer-events-none"
      />
      <div className="absolute top-0 md:-top-[10vh] left-0 right-0 h-[65vh] md:h-[90vh] bg-black/60 z-0 pointer-events-none" />
      <div className="relative z-10">
        <div className="max-w-5xl mx-auto text-center pb-20 md:pb-40">
          <div className="flex flex-col gap-6 md:gap-8 px-4 mt-80 md:mt-80">
            <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-semibold md:font-normal tracking-[0.2em] md:tracking-wider text-foreground leading-none -mt-64 md:-mt-64">
              PREMIUM CUTS
              <br />
              IN RHODES
            </h1>

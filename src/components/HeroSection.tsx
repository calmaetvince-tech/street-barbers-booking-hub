  ...
  return (
    <section className="relative overflow-hidden pt-20 md:pt-16">
      ...
      <video
        ...
        x5-playsinline="true"
        className="absolute top-16 md:-top-[35vh] left-1/2 -translate-x-1/2 w-[160%] h-[55vh] md:w-[140%] md:h-[110vh] object-contain md:object-cover object-bottom z-0 pointer-events-none"
      />

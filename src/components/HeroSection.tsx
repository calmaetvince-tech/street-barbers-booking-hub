  ...
  return (
    <section className="relative overflow-hidden pt-20 md:pt-16">
      ...
      <video
        ...
        playsInline
        preload="auto"
        className="absolute -top-[8%] md:-top-[10%] left-1/2 -translate-x-1/2 w-[160%] h-[75%] md:w-[130%] md:h-[80%] object-contain md:object-cover object-center z-0 pointer-events-none"
      />

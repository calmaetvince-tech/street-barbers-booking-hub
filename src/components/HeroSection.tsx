      ...
      <ContainerScroll
        titleComponent={
          <div className="flex flex-col gap-6 md:gap-8 px-4 mt-32 md:mt-56">
            <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-semibold md:font-normal tracking-[0.2em] md:tracking-wider text-foreground leading-none -mt-52 md:-mt-56">
              PREMIUM CUTS
              <br />
              IN RHODES
            </h1>

            <p className="font-body text-muted-foreground text-base md:text-lg max-w-sm mx-auto tracking-wide -mt-20 md:mt-40">

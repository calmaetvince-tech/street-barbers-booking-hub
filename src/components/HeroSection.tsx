  ...
  return (
    <section className="relative overflow-hidden pt-20 md:pt-16">
      ...
      <video
        ...
        x5-playsinline="true"
        className="absolute top-16 md:-top-[25vh] left-1/2 -translate-x-1/2 w-[160%] h-[55vh] md:w-[250%] md:h-[105vh] object-contain object-center z-0 pointer-events-none"
      />
      ...
      <ContainerScroll
        titleComponent={
          <div className="flex flex-col gap-6 md:gap-8 px-4 mt-32 md:mt-56">
            <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-medium md:font-normal tracking-wider text-foreground leading-none -mt-4 md:-mt-20">
              PREMIUM CUTS
              <br />
              IN RHODES
            </h1>

            <p className="font-body text-muted-foreground text-base md:text-lg max-w-sm mx-auto tracking-wide mt-24 md:mt-40">
              Precision grooming. Timeless style.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-16 md:pt-2">
              <DropdownMenu>
